const calcularPontuacao = (respostas, nivel) => {
    ...
    // Filtra as perguntas com base no nível
    perguntas = perguntas.filter(p => p.nivel === nivel);
    ...
    return {
        risco,
        detalhesPilares: defasagemPorPilar
    };
};
